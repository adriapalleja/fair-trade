...
export default class PostDetails extends React.Component {
  ...
  render(){
    let receiver = this.state.post.receiver && Object.keys(this.state.users).length ? <FormLabel>Traded with {Object.values(this.state.users).find((user)=>this.state.post.receiver === user.id).full_name}</FormLabel> : 
